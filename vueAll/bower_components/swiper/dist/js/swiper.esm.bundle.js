...
var updateSlidesClasses = function () {
  ...
  if (params.loop) {
    ...
    if (nextSlide.hasClass(params.slideDuplicateClass)) {
      $wrapperEl
        .children(`.${params.slideClass}:not(.${params.slideDuplicateClass})[data-swiper-slide-index="${nextSlide.attr('api-swiper-slide-index')}"]`)
        .addClass(params.slideDuplicateNextClass);
    } else {
      $wrapperEl
        .children(`.${params.slideClass}.${params.slideDuplicateClass}[data-swiper-slide-index="${nextSlide.attr('api-swiper-slide-index')}"]`)
        .addClass(params.slideDuplicateNextClass);
    }
    if (prevSlide.hasClass(params.slideDuplicateClass)) {
      $wrapperEl
        .children(`.${params.slideClass}:not(.${params.slideDuplicateClass})[data-swiper-slide-index="${prevSlide.attr('api-swiper-slide-index')}"]`)
        .addClass(params.slideDuplicatePrevClass);
    } else {
      $wrapperEl
        .children(`.${params.slideClass}.${params.slideDuplicateClass}[data-swiper-slide-index="${prevSlide.attr('api-swiper-slide-index')}"]`)
        .addClass(params.slideDuplicatePrevClass);
    }
  }
};
...
var updateActiveIndex = function (newActiveIndex) {
  ...
  // Get real index
  const realIndex = parseInt(swiper.slides.eq(activeIndex).attr('api-swiper-slide-index') || activeIndex, 10);
...
var updateClickedSlide = function (e) {
  ...
  if (slide && slideFound) {
    ...
    if (swiper.virtual && swiper.params.virtual.enabled) {
      swiper.clickedIndex = parseInt($(slide).attr('api-swiper-slide-index'), 10);
    } else {
...
var slideToClickedSlide = function () {
  ...
  if (params.loop) {
    ...
    realIndex = parseInt($(swiper.clickedSlide).attr('api-swiper-slide-index'), 10);
    if (params.centeredSlides) {
      if (
...
var loopCreate = function () {
  ...
  slides.each((index$$1, el) => {
    ...
    slide.attr('api-swiper-slide-index', index$$1);
  });
...
const Virtual = {
  ...
  renderSlide(slide, index$$1) {
    ...
    if (!$slideEl.attr('api-swiper-slide-index')) $slideEl.attr('api-swiper-slide-index', index$$1);
...
const Parallax = {
  setTransform(el, progress) {
    ...
    const p = $el.attr('api-swiper-parallax') || '0';
    let x = $el.attr('api-swiper-parallax-x');
    let y = $el.attr('api-swiper-parallax-y');
    const scale = $el.attr('api-swiper-parallax-scale');
    const opacity = $el.attr('api-swiper-parallax-opacity');
  ...
  setTranslate() {
    ...
    slides.each((slideIndex, slideEl) => {
      ...
      $(slideEl).find('[api-swiper-parallax], [api-swiper-parallax-x], [api-swiper-parallax-y]')
        .each((index$$1, el) => {
  ...
  setTransition(duration = this.params.speed) {
    ...
    $el.find('[api-swiper-parallax], [api-swiper-parallax-x], [api-swiper-parallax-y]')
      .each((index$$1, parallaxEl) => {
        ...
        let parallaxDuration = parseInt($parallaxEl.attr('api-swiper-parallax-duration'), 10) || duration;
...
const Lazy = {
  loadInSlide(index$$1, loadInDuplicate = true) {
    ...
    $images.each((imageIndex, imageEl) => {
      ...
      const background = $imageEl.attr('api-background');
      const src = $imageEl.attr('api-src');
      const srcset = $imageEl.attr('api-srcset');
      const sizes = $imageEl.attr('api-sizes');
      ...
      swiper.loadImage($imageEl[0], (src || background), srcset, sizes, false, () => {
        ...
        if (swiper.params.loop && loadInDuplicate) {
          const slideOriginalIndex = $slideEl.attr('api-swiper-slide-index');
  ...
  load() {
    ...
    function slideIndex(slideEl) {
      if (isVirtual) {
        return $(slideEl).attr('api-swiper-slide-index');
      }
    ...
    if (swiper.params.watchSlidesVisibility) {
      $wrapperEl.children(`.${swiperParams.slideVisibleClass}`).each((elIndex, slideEl) => {
        const index$$1 = isVirtual ? $(slideEl).attr('api-swiper-slide-index') : $(slideEl).index();
...
const History = {
  ...
  setHistory(key, index$$1) {
    ...
    let value = History.slugify(slide.attr('api-history'));
  ...
  scrollToSlide(speed, value, runCallbacks) {
    ...
    if (value) {
      for (let i = 0, length = swiper.slides.length; i < length; i += 1) {
        ...
        const slideHistory = History.slugify(slide.attr('api-history'));
...
const HashNavigation = {
  onHashCange() {
    ...
    const activeSlideHash = swiper.slides.eq(swiper.activeIndex).attr('api-hash');
  ...
  setHash() {
    ...
    if (swiper.params.hashNavigation.replaceState && win.history && win.history.replaceState) {
      ...
      const hash = slide.attr('api-hash') || slide.attr('api-history');
  ...
  init() {
    ...
    if (hash) {
      ...
      for (let i = 0, length = swiper.slides.length; i < length; i += 1) {
        const slide = swiper.slides.eq(i);
        const slideHash = slide.attr('api-hash') || slide.attr('api-history');
