...
describe('SSR: renderToString', () => {
  it('static attributes', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div id="foo" bar="123" api-server-rendered="true"></div>')
      done()
    })
  })
  ...
  it('unary tags', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<input value="123" api-server-rendered="true">')
      done()
    })
  })
  ...
  it('dynamic attributes', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div qux="quux" id="hi" bar="123" api-server-rendered="true"></div>')
      done()
    })
  })
  ...
  it('static class', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true" class="foo bar"></div>')
      done()
    })
  })
  ...
  it('dynamic class', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true" class="foo bar baz qux"></div>')
      done()
    })
  })
  ...
  it('custom component class', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true"><div class="cmp">test</div></div>')
      done()
    })
  })
  ...
  it('nested component class', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true" class="outer success">' +
  ...
  it('dynamic style', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" style="background-color:black;font-size:14px;color:red;"></div>'
      )
      done()
    })
  })
  ...
  it('dynamic string style', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" style="color:red;"></div>'
      )
      done()
    })
  })
  ...
  it('auto-prefixed style value as array', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" style="display:-webkit-box;display:-ms-flexbox;display:flex;"></div>'
      )
      done()
    })
  })
  ...
  it('custom component style', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<section api-server-rendered="true"><div style="color:red;"></div></section>'
      )
      done()
    })
  })
  ...
  it('nested custom component style', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" style="text-align:left;font-size:520rem;color:red;"></div>'
      )
      done()
    })
  })
  ...
  it('component style not passed to child', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" style="color:red;"><div></div></div>'
      )
      done()
    })
  })
  ...
  it('component style not passed to slot', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" style="color:red;"><span style="color:black;"></span></div>'
      )
      done()
    })
  })
  ...
  it('attrs merging on components', done => {
    ...
    renderVmWithOptions({
      ...
      expect(res).toContain(
        '<div id="b" api-server-rendered="true" name="c"></div>'
      )
      done()
    })
  })
  ...
  it('domProps merging on components', done => {
    ...
    renderVmWithOptions({
      ...
      expect(res).toContain(
        '<div api-server-rendered="true" value="c">b</div>'
      )
      done()
    })
  })
  ...
  it('v-show directive render', done => {
    renderVmWithOptions({
      ...
      expect(res).toContain(
        '<div api-server-rendered="true" style="display:none;"><span>inner</span></div>'
      )
      done()
    })
  })
  ...
  it('v-show directive merging on components', done => {
    renderVmWithOptions({
      ...
      expect(res).toContain(
        '<div api-server-rendered="true" style="display:none;">inner</div>'
      )
      done()
    })
  })
  ...
  it('text interpolation', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true">server side &lt;span&gt;rendering&lt;/span&gt;</div>')
      done()
    })
  })
  ...
  it('v-html on root', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true"><span>foo</span></div>')
      done()
    })
  })
  ...
  it('v-html', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true"><div><span>foo</span></div></div>')
      done()
    })
  })
  ...
  it('v-html with null value', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true"><div></div></div>')
      done()
    })
  })
  ...
  it('child component (hoc)', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true" class="foo bar">hello bar</div>')
      done()
    })
  })
  ...
  it('computed properties', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true">3</div>')
      done()
    })
  })
  ...
  it('renders async component', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<div api-server-rendered="true"><span class="b">testAsync</span></div>')
      done()
    })
  })
  ...
  it('renders async component (hoc)', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<span api-server-rendered="true" class="b">testAsync</span>')
      done()
    })
  })
  ...
  it('v-bind object', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<input id="a" api-server-rendered="true" value="c" class="a b">')
      done()
    })
  })
  ...
  it('custom directives', done => {
    ...
    renderer.renderToString(new Vue({
      ...
      expect(err).toBeNull()
      expect(result).toContain('<p api-server-rendered="true" class="my-class2 my-class1">hello world</p>')
      done()
    })
  })
  ...
  it('_scopeId', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div id="foo" api-server-rendered="true" _v-parent>' +
          '<p _v-parent>' +
  ...
  it('_scopeId on slot content', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain(
        '<div api-server-rendered="true" _v-parent>' +
  ...
  it('render muted properly', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<video muted="muted" api-server-rendered="true"></video>')
      done()
    })
  })
  ...
  it('render v-model with textarea (non-optimized)', done => {
    renderVmWithOptions({
      ...
      expect(result).toContain('<textarea api-server-rendered="true">foo</textarea>')
      done()
    })
  })
