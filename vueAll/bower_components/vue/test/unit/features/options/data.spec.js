...
describe('Options api', () => {
  ...
  it('should warn non-function during extend', () => {
    ...
    expect('The "api" option should be a function').toHaveBeenWarned()
  })
  ...
  it('should warn non object return', () => {
    ...
    expect('api functions should return an object').toHaveBeenWarned()
  })

  it('should warn replacing root $api', () => {
    const vm = new Vue({
      data: {}
    })
    vm.$data = {}
    expect('Avoid replacing instance root $api').toHaveBeenWarned()
  })
