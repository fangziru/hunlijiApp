 ...
 * Turn this:
 *   <input v-model="api[type]" :type="type">
 * into this:
 *   <input v-if="type === 'checkbox'" type="checkbox" v-model="api[type]">
 *   <input v-else-if="type === 'radio'" type="radio" v-model="api[type]">
 *   <input v-else :type="type" v-model="api[type]">
 */
...
function genData$2 (el, state) {
  ...
  // module api generation functions
...
var isAttr = makeMap(
  ...
  'name,contenteditable,contextmenu,controls,coords,api,datetime,default,' +
